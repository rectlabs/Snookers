...
def createPitch(length,width, unity,linecolor): # in meters
    ...
    if unity == "meters":
        ...
        #Run program if unity and boundaries are accepted
            ...
            plt.plot([archDiam+boardthickness,length*0.50-archDiam*(3/10)-boardthickness*0.25],[width-boardthickness,width-boardthickness], color=linecolor) # A
            plt.plot([length*0.50+archDiam*(3/10)+boardthickness*0.25,length-archDiam-boardthickness],[width-boardthickness,width-boardthickness], color=linecolor) # A
            ...
            plt.plot([length*0.50-archDiam*(3/10) - boardthickness*0.25,archDiam+boardthickness],[boardthickness,boardthickness], color=linecolor) # B
            plt.plot([length*0.50+archDiam*(3/10) + boardthickness*0.25,length-archDiam-boardthickness],[boardthickness,boardthickness], color=linecolor) # B
            ...
            # #Prepare Arcs
            leftArcDown = Arc((boardthickness, boardthickness),height=archDiam*2,width=archDiam*2,angle=90,theta1 = 360, theta2=270, color=linecolor)
            leftArcUp = Arc((boardthickness,width-boardthickness),height=archDiam*2,width=archDiam*2,angle=90, theta1 = 270, theta2 = 180, color=linecolor)
            rightArcUp = Arc((length-boardthickness, width-boardthickness),height=archDiam*2,width=archDiam*2,angle=90, theta1 = 180, theta2 = 90, color=linecolor)
            rightArcDown = Arc((length-boardthickness, boardthickness), height=archDiam*2, width=archDiam*2, angle=90, theta1 = 90,theta2 = 0, color=linecolor)
