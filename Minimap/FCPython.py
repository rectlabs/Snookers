...
def createPitch(length,width, unity,linecolor): # in meters
    ...
    if unity == "meters":
        ...
        #Run program if unity and boundaries are accepted
            ...
            plt.plot([archDiam+boardthickness,length*0.50-archDiam*(5/3)-boardthickness*0.25],[width-boardthickness,width-boardthickness], color=linecolor) # A
            plt.plot([length*0.50+archDiam*(5/3)+boardthickness*0.25,length-archDiam-boardthickness],[width-boardthickness,width-boardthickness], color=linecolor) # A
            ...
            plt.plot([length*0.50-archDiam*(5/3) - boardthickness*0.25,archDiam+boardthickness],[boardthickness,boardthickness], color=linecolor) # B
            plt.plot([length*0.50+archDiam*(5/3) + boardthickness*0.25,length-archDiam-boardthickness],[boardthickness,boardthickness], color=linecolor) # B
